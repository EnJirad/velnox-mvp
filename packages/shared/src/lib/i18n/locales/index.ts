...
const myShopPatch = {
  ...
  addresses: {
    ...
    dialogDesc: "မြေပုံကို ဆွဲ၍ လိုချင်သောနေရာ ပင်အောက် အလယ်တွင် ရောက်အောင်ထားပါ — ထို့နောက် “ဤနေရာကို အတည်ပြုရန်” နှိပ်ပါ",
  ...
  mapPicker: {
    ...
    map: "မြေပုံ",
    failed: "လက်ရှိတည်နေရာ ရယူ၍မရပါ — မြေပုံကို ဆွဲ၍ နေရာရွေးပြီး အတည်ပြုပါ",
    dragHint: "နေရာရွှေ့ရန် မြေပုံကို ဆွဲပါ — ရွေးချယ်သည့်နေရာသည် ပင်အောက် အလယ်ဗဟိုဖြစ်သည်",
