...
export default function Profile() {
  ...
  const coverUrl = useQuery(
    api.files.getImageUrl,
    user?.coverImage ? { storageId: user.coverImage as Id<"_storage"> } : "skip",
  );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      let coverImage: Id<"_storage"> | undefined;
      if (pendingAvatar) image = await uploadImage(pendingAvatar);
      if (pendingCover) coverImage = await uploadImage(pendingCover);
